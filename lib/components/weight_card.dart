...
import 'package:simple_weight_management/my_page/my_page_notifier.dart';

class WeightCard extends StatelessWidget {
  const WeightCard._({Key key, this.records, this.index}) : super(key: key);
